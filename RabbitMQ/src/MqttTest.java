...
public class MqttTest implements MqttCallback {
    ...
    private final byte[] payload = ("{foo: bar, lat: 0.23443, long :12.3453245}").getBytes();
    ...
    public  void tearDownMqtt() throws MqttException {
        ...
        try {
            ...
            client.disconnect();
            System.out.println("cleint 1 disconnected");
        } catch (Exception _) {}
        ...
        try {
            ...
            client2.disconnect();
            System.out.println("client 2 disconected.");
        } catch (Exception _) {}
    }
